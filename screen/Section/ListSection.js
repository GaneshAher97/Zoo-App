...
const ListSection = () => {
    ...
    const renderItem = (item) => {
        console.log(item);
        const { seciton_id, section_name, section_incharge, section_description, created_at, section_latitude, section_longitude } = item;
        return (
            <View style={[styles.listContainer, styles.shadow]}>
                <View style={styles.header}>
                    <View style={styles.innerHeader}>
                        <Text>ID : </Text>
                        <Text style={styles.idNumber}>{`#${seciton_id}`}</Text>
                    </View>
